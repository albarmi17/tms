				...
				<div class="row clearfix">
					<div class="col-md-7">
						...
						<div class="form-group">
							<input type="text" name="nama_karyawan" value="<?php echo $this->input->post('nama_karyawan'); ?>" class="form-control" id="nama_karyawan" />
					...
					<div class="col-md-7">
						...
						<div class="form-group">
							<input type="text" name="departemen_karyawan" value="<?php echo $this->input->post('departemen_karyawan'); ?>" class="form-control" id="departemen_karyawan" />
					...
					<div class="col-md-7">
						...
						<div class="form-group">
							<input type="text" name="posisi_karyawan" value="<?php echo $this->input->post('posisi_karyawan'); ?>" class="form-control" id="posisi_karyawan" />
