			...
			<div class="box-body">
				<div class="row clearfix">
						...
						<div class="form-group">
							<select name="id_profile" class="form-control">
								...
								foreach ($all_profile as $profile) {
									$selected = ($profile['id_profile'] == $jadwal['id_profile']) ? ' selected="selected"' : "";
						...
						<div class="form-group">
							<select name="id_user" class="form-control">
								...
								foreach ($all_user as $user) {
									$selected = ($user['id_user'] == $jadwal['id_user']) ? ' selected="selected"' : "";
									if ($user['level'] != 1) {
					...
					<div class="col-md-7">
						...
						<div class="form-group">
							<input type="date" name="tanggal" value="<?php echo ($this->input->post('tanggal') ? $this->input->post('tanggal') : $jadwal['tanggal']); ?>" class="form-control" id="tanggal" />
